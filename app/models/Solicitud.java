...
public class Solicitud {
    ...
    private Respaldo _respaldo;
    private Number _valorAprobado;
    private Empleado _analista;
     ...
     */
    public void set_garantia(Garantia _garantia) {
     ...
     */
    public TipoCuota get_tipoCuota() {
        return _tipoCuota;
    }
     ...
     */
    public void set_tipoCuota(TipoCuota _tipoCuota) {
     ...
     * @return the _estado
     */
    public EstadoSolicitud get_estado() {
        return _estado;
    }
     ...
     */
    public void set_estado(EstadoSolicitud _estado) {
     ...
     */
    public void set_linea(Linea _linea) {
        this._linea = _linea;
    }
    ...
    */
     ...
     */
    public void set_oficina(Agencia _oficina) {
     ...
     */
    public EnteAprobador get_enteAprobador() {
     ...
     */
    public void set_enteAprobador(EnteAprobador _enteAprobador) {
     ...
     */
    public void set_respaldo(Respaldo _respaldo) {
     ...
     */
    public void set_analista(Empleado _analista) {
     ...
     */
    public Inversion get_inversion() {
        return _inversion;
    }
     ...
     */
    public void set_inversion(Inversion _inversion) {
     ...
     */
    public Clasificacion get_clasificacion() {
     ...
     */
    public void set_clasificacion(Clasificacion _inversion) {
    ...
    public SolicitudDTO create() {
        SolicitudDTO o = new SolicitudDTO();
